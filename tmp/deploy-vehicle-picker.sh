...
echo
curl -s -o /dev/null -w "buyer_home=%{http_code}\n" https://partsbazar360.com/buyer/ || true
curl -s -o /dev/null -w "vehicles_makes=%{http_code} time=%{time_total}\n" https://partsbazar360.com/api/vehicles/makes || true
