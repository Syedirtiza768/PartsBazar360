...
export default function MessagesPage() {
  return (
    <section>
      <div className="border-b-2 border-graphite-950 pb-3"><p className="eyebrow">Seller communication</p><h2 className="mt-1 font-display text-2xl font-black uppercase text-slate-950 sm:text-3xl">Messages</h2><p className="mt-2 max-w-2xl text-pretty text-sm text-graphite-700">Ask about fitment, condition, photographs, dispatch, or a purchase. Starting from a listing or order automatically carries the right context.</p></div>
