  ...
  return (
    ...
    >
      ...
      <body className="flex min-h-dvh flex-col">
        ...
        {/*
          Site-wide Organization + WebSite nodes, emitted once here and
          referenced by `@id` from every page's graph. Generated by the shared
          engine so the publisher identity in a product page's JSON-LD is the
          same object the site declares, rather than a second copy that can
          drift.
        */}
        <script
