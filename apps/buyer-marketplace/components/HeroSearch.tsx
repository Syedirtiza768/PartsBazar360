...
export function HeroSearch() {
  ...
  const activateItem = useCallback(
    ...
    [hasQuery, query, results, recents, submit, navigateToPart, searchActionEnd, partsEnd, suggestGroupEnd, suggestCatEnd, suggestBrandEnd, suggestMakeEnd, suggestTagEnd, recentsStart, recentsEnd],
  );
                      ...
                      {results.categoryGroups.map((categoryGroup, i) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <span className="min-w-0 truncate">{categoryGroup}</span>
                      ...
                      {results.makes.map((make, i) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <span className="min-w-0 truncate">{make}</span>
                            <ChevronRightIcon className="ml-auto h-4 w-4 shrink-0 text-slate-400" />
                          </button>
                        );
                      })}
