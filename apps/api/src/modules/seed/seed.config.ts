export interface SeedStoreConfig {
  storeId: string;
  name: string;
}
...
export const REALTRACK_STORE_MANIFEST: SeedStoreConfig[] = [
  {
    storeId: '79f249a5-31e0-42a8-978c-a99b0665c61b',
  ...
  { storeId: 'fa528c8a-f249-4816-94f6-f2ce8b932449', name: 'B.JLRWORLD' },
  {
    ...
    name: 'BLACKLINEAUTOPARTS',
  },
  {
    storeId: '5fc75f19-31f3-44e4-b1ae-6545055f7945',
    name: 'K. Brit Auto Depot - UK',
  },
  {
    storeId: '65aff8ec-21ee-460f-af17-20daa0b843c1',
    name: 'K. Euro Japan Auto Parts',
  },
  {
    storeId: 'eed3dbd6-9967-43ac-ad4e-6d5081cfb9b0',
    name: 'K. Salvage Auto Parts',
  },
  {
    storeId: 'cc658cc0-ab21-4519-9f06-4aea8ff6a809',
    name: 'K. Salvage Dismantlers - DE',
  },
  {
    storeId: '7658e52e-4dd6-48a7-ad78-6933630bdac7',
    name: 'K. Southern Cross Auto Parts - AU',
  },
...
export const INITIAL_MARKETPLACE_REALTRACK_STORES: SeedStoreConfig[] =
  REALTRACK_MARKETPLACE_SELLERS.map((s) => ({
    storeId: s.storeId!,
    name: s.name,
  }));
...
export function storeManifest(): SeedStoreConfig[] {
  if (process.env.REALTRACK_STORE_MANIFEST_JSON) {
    ...
    if (!Array.isArray(parsed))
      throw new Error('REALTRACK_STORE_MANIFEST_JSON must be an array');
    return parsed;
  }
