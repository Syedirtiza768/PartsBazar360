  ...
  return (
    <aside className="w-64 bg-zinc-950 text-zinc-300 border-r border-zinc-800 h-screen flex flex-col">
      <div className="p-6">
        ...
        <p className="text-xs text-zinc-500 mt-1 uppercase tracking-wider">Admin Console</p>
      </div>
      ...
      <div className="p-4 border-t border-zinc-800">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-zinc-800 border border-zinc-700 flex items-center justify-center">A</div>
          <div className="flex flex-col">
            <span className="text-sm font-medium text-white">Platform Admin</span>
            <span className="text-xs text-zinc-500">admin@partsbazar360.com</span>
          </div>
        </div>
      </div>
    </aside>
